package bg.softuni.model.validators;
...
public class FieldMatchValidator implements ConstraintValidator<FieldMatch, Object> {
    ...
    @Override
    public boolean isValid(Object someObject, ConstraintValidatorContext context) {
        BeanWrapper beanWrapper = PropertyAccessorFactory.forBeanPropertyAccess(someObject);
